...
FIXTURE_TRANSFORMS = [
    ...
    # 1. Persons
    ('patient*.json',         transform_patient,          'person',               'PersonMapR4'),
    ('Patient-Pat-*.json',    transform_patient,          'person',               'PersonMapR4'),

    # 2. Visits (must exist before condition, procedure, observation, drug, measurement)
    ('encounter_*.json',      transform_encounter,  'visit_occurrence',     'EncounterVisitMapR4'),

    # 3. Clinical records
    ('condition_*.json',      transform_condition,        'condition_occurrence', 'ConditionMapR4'),
    ('procedure_*.json',      transform_procedure,        'procedure_occurrence', 'ProcedureMapR4'),
    ('immunization_*.json',   transform_immunization,     'drug_exposure',        'ImmunizationMapR4'),
    ('observation_*weight*.json',           transform_measurement, 'measurement',  'MeasurementMapR4'),
    ('observation_*creatinine*.json',       transform_measurement, 'measurement',  'MeasurementMapR4'),
    ('observation_*sodium*.json',           transform_measurement, 'measurement',  'MeasurementMapR4'),
    ('observation_*NEG*.json',              transform_measurement, 'measurement',  'MeasurementMapR4'),
    ('observation_*temp*.json',             transform_vital_signs, 'measurement',  'SimpleVitalSignsMapR4'),
    ('observation_*heartrate*.json',        transform_vital_signs, 'measurement',  'SimpleVitalSignsMapR4'),
    ('observation_bp*.json',                transform_bp_panel,    'measurement',  'BloodPressureVitalSignsMapR4'),
    ('observation_bp*.json',                transform_bp_systolic, 'measurement',  'BloodPressureSystolicMapR4'),
    ('observation_bp*.json',                transform_bp_diastolic,'measurement',  'BloodPressureDiastolicMapR4'),
    ('observation_*blood*.json',            transform_bp_panel,    'measurement',  'BloodPressureVitalSignsMapR4'),
    ('observation_*blood*.json',            transform_bp_systolic, 'measurement',  'BloodPressureSystolicMapR4'),
    ('observation_*blood*.json',            transform_bp_diastolic,'measurement',  'BloodPressureDiastolicMapR4'),
    ('observation_smoking*.json',           transform_observation, 'observation',  'ObservationMapR4'),
    ('allergy_*.json',        transform_allergy,    'observation',          'AllergyMapR4'),
    ('medicationrequest*.json',   transform_medication, 'drug_exposure',        'MedicationRequestMapR4'),
    ('medicationstatement*.json', transform_medication, 'drug_exposure',        'MedicationMapR4'),
]
...
FIXTURE_TRANSFORMS_R5 = [
    ...
    ('medicationstatement*.json', transform_medication_r5, 'drug_exposure',       'MedicationStatementMap'),
]
